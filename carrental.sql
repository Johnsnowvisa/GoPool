...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 30, 2024 at 08:33 PM
...
INSERT INTO `tblrides` (`id`, `start_place`, `end_place`, `postedby`, `capacity`, `message`, `date_of_travel`, `time_of_travel`, `duration`, `distance`, `created_at`) VALUES
(3, 'Kandy City Centre, Sri Dalada Veediya, Kandy, Sri Lanka', 'Badulla, Sri Lanka', 'Logenthiran Visagan', 3, 'In this ride we can share the fuel cost.', '2024-07-06', '10:30:00', '2 hours 54 mins', '115 km', '2024-06-30 16:04:35');
